...
# print("MICS", sr.Microphone.list_working_microphones())
model_size = 'medium'  # @param ['tiny', 'base', 'small', 'medium', 'large']
whisper_model = whisper.load_model(model_size)
speaker_path = "/home/blabs/Companion-Core/dynamic-system/core/audio/speaker.wav"
...
def listen_for_speech():
    ...
    while True:
        ...
        try:
            ...
            for (i, segment) in enumerate(segments):
                speech_data = "\n" + segment["speaker"] + segment["text"][1:] + ' '
